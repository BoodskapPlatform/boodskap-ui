...
function toggleView(viewmode) {
    ...
    switch (viewmode) {
        case 'Table':
            ...
            $('#tablemode').removeClass('d-none'); 
            console.log("Table");
            break;
        case 'Chart':
            $('#chartPanel').removeClass('d-none'); 
            $('#tablemode').addClass('d-none'); 
            mesgstat_linechart()
            mesgprocess_linechart()
            console.log("Chart");
            break;
...
function mesgstat_linechart() {
    $("#mesgstatChart").html('<div id="mesgstatChartdiv"  style="height: 300px;margin:auto!important;"></div>');
    var chartDom = document.getElementById('mesgstatChartdiv');
    var myChart = echarts.init(chartDom);
...
function mesgprocess_linechart() {
    $("#mesgprocessChart").html('<div id="mesgprocessChartdiv"  style="height: 300px;margin:auto!important;"></div>');
    var chartDom = document.getElementById('mesgprocessChartdiv');
    var myChart = echarts.init(chartDom);
    ...
    option = {
        ...
        title: {
            left: 'center',
            subtext: 'Message Processed Statistics',
            subtextStyle: {
                fontSize: 13,
                color:'#fffff'
            },
