          ...
          , r = function() {
            ...
            return f(c, [{
                ...
                value: function() {
                    ...
                    if (!this.d.showFlags && b && (this.d.showFlags = !0),
                ...
                value: function() {
                    ...
                    k && (this.selectedFlag = this._e2("div", b({
                    ...
                    e && (this.l = this._e2("div", {
                        "class": "iti__flag"
                    }, this.selectedFlag)),
                    this.selectedFlag && this.a.disabled && this.selectedFlag.setAttribute("aria-disabled", "true"),
                    d && (this.t = this._e2("div", {
                        "class": "iti__selected-dial-code"
                    }, this.selectedFlag)),
                    c && (this.a.disabled || this.selectedFlag.setAttribute("tabindex", "0"),
                    this.u = this._e2("div", {
                        "class": "iti__arrow"
                    }, this.selectedFlag),
                    this.m = this._e2("ul", {
                ...
                value: function(a, b, c) {
                    for (var d = "", e = 0; e < a.length; e++) {
                        ...
                        this.d.showFlags && (d += "<div class='iti__flag-box'><div class='iti__flag iti__".concat(f.iso2, "'></div></div>")),
                ...
                key: "_o",
                value: function() {
                    var a = this;  console.log(this,this.d.dropdownContainer);
                ...
                value: function(a) {
                    var b = a
                      , c = this.s.dialCode
                      , d = "1" === c;
                    b && d && "+" !== b.charAt(0) && ("1" !== b.charAt(0) && (b = "1".concat(b)),
                    b = "+".concat(b)),
                ...
                value: function(a) {
                    ...
                    if (this.s = a ? this._y(a, !1, !1) : {},
                    this.s.iso2 && (this.j = this.s.iso2),
                    this.d.showFlags && this.l.setAttribute("class", "iti__flag iti__".concat(a)),
                    this.selectedFlag) {
                ...
                value: function(a) {
                    ...
                    if ("+" === c.charAt(0)) {
                        ...
                        this.d.autoInsertDialCode && (b = c ? d + c : d,
                        this.a.value = b)
                }
            }, {
                key: "_5",
                ...
                value: function() {
                    ...
                    this.d.autoInsertDialCode && (a && a.removeEventListener("submit", this._a8),
