...
var INDEX_MODELS = ['ACCESS',"ALEXA","ASSET","ASSET_GROUP","AUDIT",'BILLING','CONTACT','CONNECTION_POOL',"COMMAND",'DB_METADATA','DB_TEMPLATE',"DEVICE",
    ...
    "PUBLIC_GROOVY_JAR",'LOG',"LOCATION","LOCATION_HISTORY","NOTIFICATION","OBJECT","PUBLIC_GROOVY","PUBLIC_NOTIFICATION","PLUGIN","REPORTED_DEVICE",
    "RULE_FAILURE","SCREEN","SCREEN_VERSION","SCREEN_IMPORTED","SMS","SQL_TABLE","SQL_TEMPLATE","USER","USER_ASSET_GROUP","USER_DEVICE_GROUP","USER_GROUP",
    "VERTICAL","VERTICAL_IMPORTED","VERTICAL_PUBLISHED","VERTICAL_VERSION","VOICE","WIDGET","WIDGET_IMPORTED","WIDGET_PUBLISHED","WIDGET_VERSION",
    "ASSET_GROUP_MEMBER","DEVICE_GROUP_MEMBER","DOMAIN_ASSET_GROUP_MEMBER","DOMAIN_DEVICE_GROUP_MEMBER","USER_ASSET_GROUP_MEMBER","USER_DEVICE_GROUP_MEMBER",
    "USER_GROUP_MEMBER","ORGANIZATION","ORGANIZATION_USER","ORGANIZATION_DEVICE","ORGANIZATION_ASSET","ORGANIZATION_ROLE","ORGANIZATION_USER_ROLE",
    "ORGANIZATION_USER_DEVICE","ORGANIZATION_USER_ASSET","PROCESS", "WORKFLOW", "WORKFLOW_INSTANCE", "GLOBAL_PROCESS", "GLOBAL_WORKFLOW", "GLOBAL_WORKFLOW_INSTANCE", "TRIGGER", "TRIGGER_GROUP",
    "GLOBAL_TRIGGER", "GLOBAL_TRIGGER_GROUP",
    "SFTP_INPUT","ORG_SFTP_INPUT","GLOBAL_SFTP_INPUT","SYSTEM_SFTP_INPUT","MQTT_INPUT","ORG_MQTT_INPUT","GLOBAL_MQTT_INPUT","SYSTEM_MQTT_INPUT","UDP_INPUT","ORG_UDP_INPUT","GLOBAL_UDP_INPUT",
    "SYSTEM_UDP_INPUT","TCP_INPUT","ORG_TCP_INPUT","GLOBAL_TCP_INPUT","SYSTEM_TCP_INPUT","EMAIL_INPUT","ORG_EMAIL_INPUT","GLOBAL_EMAIL_INPUT","SYSTEM_EMAIL_INPUT"];
