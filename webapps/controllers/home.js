...
function modalnavigate(ch){
    $('.right-content, .active-step').addClass('d-none');
    let utubeLink="https://www.youtube.com/embed/"
    switch(ch){
    case 1:
        ...
        $('.active-step.tab'+ch).removeClass('d-none'); 
        $('.right-content.sec'+ch).removeClass('d-none'); 
        $('iframe').attr('src', utubeLink+"s8Zb6CIA2nU");
        break;
    case 2:
        console.log("one"+ch);
      ...
      $('.landmark.tab1').addClass('is-done active-dot'); 
      $('.active-step.tab'+ch).removeClass('d-none'); 
      $('iframe').attr('src', utubeLink+"MF8I4w2BcIQ"); 
      break;
    case 3:
        console.log("one"+ch);
      ...
      $('.active-step.tab'+ch).removeClass('d-none'); 
      $('iframe').attr('src', utubeLink+"A6gswxLTx_o");
    break;
    case 4:
        console.log("one"+ch);
    ...
    case 5:
        console.log("one"+ch);
      $('.right-content.sec4').html('<p> Successfully Completed </p>');
      $('.landmark.tab4').addClass('is-done active-dot'); 
      $('.active-step.tab'+ch).removeClass('d-none'); 
    break;
    }
    }
