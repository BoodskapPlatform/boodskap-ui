...
var MENU_LINKS = [BASE_PATH+'/home', BASE_PATH+'/dashboard', BASE_PATH+'/message-definition', BASE_PATH+"/record-definition", BASE_PATH+"/rules-engine", BASE_PATH+"/script-console",
    ...
    BASE_PATH+"/messages", BASE_PATH+"/log-console", BASE_PATH+"/marketplace/widgets", BASE_PATH+"/domain-audit", BASE_PATH+"/files", BASE_PATH+"/code-editor", BASE_PATH+"/alexa", BASE_PATH+"/query-console", BASE_PATH+"/sql-query-console",
