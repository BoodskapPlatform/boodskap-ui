...
var floatSubMenuTimeout, targetFloatMenu, handleSlimScroll = function () {
    ...
    $(".sidebar .nav > .has-sub > a").click(function () {
        var a = $(this).next(".sub-menu"), t = $(".sidebar .nav > li.has-sub > .sub-menu").not(a);
    ...
    $(".sidebar").bind("click touchstart", function (a) {
        ...
        a.stopPropagation();
        var t = "#page-container", n = "page-right-sidebar-collapsed";
        ...
        a.stopPropagation();
        var t = "page-sidebar-toggled", n = "#page-container";
    ...
    panelActionRunning = !0, $(document).on("hover", "[data-click=panel-remove]", function (e) {
        ...
        if (!$(a).hasClass("panel-loading")) {
            ...
            $(a).addClass("panel-loading"), $(t).prepend('<div class="panel-loader"><p class="spinner-block"><span class="spinner-small"></span> <span>Processing...</span> </p></div>'), setTimeout(function () {
    ...
    //         a.item.find(".panel-title").append('<i class="fa fa-redo fa-spin m-l-5" data-id="title-spinner"></i>'), handleSavePanelPosition(a.item)
    //     }
    // })
    ...
    function e(e, a) {
        var t = $(e).closest(".tab-overflow"), n = parseInt($(t).find(".nav.nav-tabs").css("margin-left")),
            i = $(t).width(), o = 0, s = 0;
        switch ($(t).find("li").each(function () {
            ...
            case"next":
                ...
                }, 150)) : s = i - n - 80, 0 != s && $(t).find(".nav.nav-tabs").animate({marginLeft: "-" + s + "px"}, 150, function () {
                    $(t).addClass("overflow-left")
                });
                break;
            case"prev":
                var l;
                (l = -n) <= i ? ($(t).removeClass("overflow-left"), s = 0) : s = l - i + 80, $(t).find(".nav.nav-tabs").animate({marginLeft: "-" + s + "px"}, 150, function () {
    ...
    function a() {
        $(".tab-overflow").each(function () {
            ...
            $(t).find("li").each(function () {
                ...
                var n = $(e).width(), i = $(e).find(t).width(), o = a > -1 ? a : 150, s = 0;
    ...
    function e(e, a) {
        var t = $(e).closest(".nav"), n = parseInt($(t).css("margin-left")), i = $(".top-menu").width() - 88, o = 0,
            s = 0;
        switch ($(t).find("li").each(function () {
            ...
            case"next":
                ...
                }, 150)) : s = i - n - 128, 0 != s && $(t).animate({marginLeft: "-" + s + "px"}, 150, function () {
                    $(t).find(".menu-control.menu-control-left").addClass("show")
                });
                break;
            case"prev":
                var l;
                (l = -n) <= i ? ($(t).find(".menu-control.menu-control-left").removeClass("show"), s = 0) : s = l - i + 88, $(t).animate({marginLeft: "-" + s + "px"}, 150, function () {
    ...
    function a() {
        var e = $(".top-menu .nav"), a = $(".top-menu .nav > li"), t = $(".top-menu .nav > li.active"),
            n = $(".top-menu"), i = (parseInt($(e).css("margin-left")), $(n).width() - 128),
            o = $(".top-menu .nav > li.active").width(), s = 0;
    ...
    return '4.0.0';//$.fn.tooltip.Constructor.VERSION
    ...
    $('[data-toggle="nav-profile"]').click(function (a) {
        a.preventDefault();
        var t = $(this).closest("li"), n = $(".sidebar .nav.nav-profile"), i = "expanding", o = "closing";
    ...
    $(document).on("click", "#float-sub-menu li.has-sub > a", function (e) {
        var a = $(this).next(".sub-menu"), t = $(a).closest("li"), n = !1, i = !1;
        $(a).is(":visible") ? ($(t).addClass("closing"), n = !0) : ($(t).addClass("expanding"), i = !0), $(a).slideToggle({
            duration: 250,
            progress: function () {
                var e = $("#float-sub-menu"), a = $(e).height(), t = $(e).offset(), o = $(e).attr("data-offset-top"),
                    s = $(e).attr("data-menu-offset-top"), l = t.top - $(window).scrollTop(), r = $(window).height();
                if (n && l > o && (l = l > o ? o : l, $("#float-sub-menu").css({
                        ...
                        top: "20px",
                        bottom: "auto"
                    }), $("#float-sub-menu-line").css({top: "20px", bottom: "auto"})), i && r - l < a) {
                    var d = r - s - 22;
        ...
        if ($("#page-container").hasClass("page-sidebar-minified")) {
            ...
            if (a) {
                var t = $("#sidebar").offset(),
                    ...
                    i = $(e).height(), o = $(this).offset().top - $(window).scrollTop(),
...
}, CLEAR_OPTION = "", handleAjaxMode = function (e) {
    ...
    function i(t, i, o) {
        ...
        var d = "#content", c = t.replace("#", ""), h = e.ajaxType ? e.ajaxType : "GET",
    ...
    return {
        init: function (a) {
            ...
            handleSidebarMenu(), handleMobileSidebarToggle(), handleSidebarMinify(), handleSidebarMinifyFloatMenu(), handleToggleNavProfile(), handleToggleNavbarSearch(), (!e || e && !e.disableSidebarScrollMemory)
            ...
            handleDraggablePanel(), handleIEFullHeightContent(), handleSlimScroll(), handleUnlimitedTabsRender(), handlePanelAction(), handelTooltipPopoverActivation(), handleScrollToTopButton(), handleAfterPageLoadAddClass(), handlePageScrollClass()
