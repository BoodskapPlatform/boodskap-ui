...
Routes.prototype.init = function () {
    ...
    self.router.get('/domain', roleCheck, function (req, res) {
        res.render('domain.html',{layout:'',basepath: getBasePath(req), userRole:req.session.role, buildVersion: self.app.conf.buildVersion, billapi: self.app.conf.billing_api});
    });
